    ...
    /*'error': function(jqXHR, textStatus, errorThrown) {
        ...
        switch (textStatus) {
            ...
            case 'parsererror':
                ...
                break;
            case 'error':
                if (errorThrown === '') fx.messageBox("Lỗi", "Không kết nối được với máy chủ. Vui lòng thử lại sau.");
                else if (errorThrown !== 0 && errorThrown !== '0') alert('Lỗi máy chủ: ' + errorThrown + '. Vui lòng thử lại.');
                break;
            default:
